...
iage = int(age)
days = (90*365) - (iage*365) 
sdays = str(days)

weeks = (90*52) - (iage * 52)
sweeks = str(weeks)
months = (90*12) - (iage * 12)
smonths = str(months)

print('You have ' + sdays + ' days, ' + sweeks + " weeks, and " + smonths + ' months left.')
...
# Grabbing tests as well to review
# https://repl.it/@appbrewery/day-2-3-test-your-code#main.py